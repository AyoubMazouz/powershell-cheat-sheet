export default function Options ({ options, setOptions }) {
    ...
    return (
        <div className='flex justify-around px-4 space-x-2 text-gray-700 font-semibold text-sm'>
            <div className={options.cmdlet ? 'space-x-2 h-8 w-24 rounded-lg flex justify-center items-center bg-blue-400' : 'space-x-2 h-8 w-24 rounded-lg flex justify-center items-center bg-gray-400'}>
            ...
            <div className={options.function ? 'space-x-2 h-8 w-24 rounded-lg flex justify-center items-center bg-orange-400' : 'space-x-2 h-8 w-24 rounded-lg flex justify-center items-center bg-gray-400'}>
